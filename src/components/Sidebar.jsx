...
const IconLive = () => (
  <svg viewBox="0 0 20 20" className="w-3.5 h-3.5 fill-current" aria-hidden>
    ...
    <path d="M6.343 6.343a4 4 0 0 0 0 5.657M13.657 6.343a4 4 0 0 1 0 5.657M4.222 4.222a7 7 0 0 0 0 9.9M15.778 4.222a7 7 0 0 1 0 9.9" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" fill="none" />
  </svg>
);
    ...
    <aside className="w-[220px] shrink-0 h-full bg-[#0d1220] border-r border-[#1e2a45] flex flex-col">
      ...
      <div className="px-4 py-4 border-b border-[#1e2a45]">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-blue-600 flex items-center justify-center shrink-0">
            <svg viewBox="0 0 20 20" className="w-4.5 h-4.5" aria-hidden>
      ...
      <div className="px-4 py-3 border-b border-[#1e2a45]">
        <div className="flex items-center gap-2 px-2.5 py-2 rounded-lg bg-[#111827] border border-[#1e2a45] cursor-pointer hover:border-slate-600 transition-colors">
          <div className="w-5 h-5 rounded bg-gradient-to-br from-violet-500 to-blue-600 flex items-center justify-center text-[9px] font-bold text-white shrink-0">
            A
          </div>
      ...
      <div className="px-4 py-3 border-t border-[#1e2a45]">
        <div className="flex items-center gap-2 px-2.5 py-2 rounded-lg bg-emerald-950/30 border border-emerald-900/30">
          ...
          <IconLive className="text-emerald-600" />
        </div>
      </div>
